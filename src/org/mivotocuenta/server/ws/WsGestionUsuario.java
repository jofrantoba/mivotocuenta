...
@Api(name = "wsgestionusuario", namespace = @ApiNamespace(ownerDomain = "mivotocuenta.org", ownerName = "mivotocuenta.org", packagePath = "server.ws"))
public class WsGestionUsuario {
	...
	private boolean containsUsuario(Usuario usuario) {
		...
		try {
			mgr.getObjectById(Usuario.class, usuario.getIdUsuario());
