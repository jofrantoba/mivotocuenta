...
package org.mivotocuenta.server.ws.wsgestionusuario;

/**
 * Service definition for Wsgestionusuario (v1).
 *
 * <p>
 * This is an API
 * </p>
 ...
 *
 * <p>
 * This service uses {@link WsgestionusuarioRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class Wsgestionusuario extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.18.0-rc of the wsgestionusuario library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "wsgestionusuario/v1/";
   ...
   * @since 1.7
   */
  public Wsgestionusuario(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
   ...
   */
  Wsgestionusuario(Builder builder) {
    super(builder);
  }
   ...
   *
   * This request holds the parameters needed by the wsgestionusuario server.  After setting any
  ...
  public class GetUsuario extends WsgestionusuarioRequest<org.mivotocuenta.server.ws.wsgestionusuario.model.Usuario> {
     ...
     * Create a request for the method "getUsuario".
     *
     * This request holds the parameters needed by the the wsgestionusuario server.  After setting any
    ...
    protected GetUsuario(java.lang.Long id) {
      super(Wsgestionusuario.this, "GET", REST_PATH, null, org.mivotocuenta.server.ws.wsgestionusuario.model.Usuario.class);
   ...
   * operation.
   *
   * @param content the {@link org.mivotocuenta.server.ws.wsgestionusuario.model.Usuario}
   * @return the request
   */
  public InsertUsuario insertUsuario(org.mivotocuenta.server.ws.wsgestionusuario.model.Usuario content) throws java.io.IOException {
    InsertUsuario result = new InsertUsuario(content);
    initialize(result);
    return result;
  }

  public class InsertUsuario extends WsgestionusuarioRequest<org.mivotocuenta.server.ws.wsgestionusuario.model.Usuario> {
     ...
     * @since 1.13
     */
    protected InsertUsuario(org.mivotocuenta.server.ws.wsgestionusuario.model.Usuario content) {
      super(Wsgestionusuario.this, "POST", REST_PATH, content, org.mivotocuenta.server.ws.wsgestionusuario.model.Usuario.class);
    }
  ...
  public class ListUsuario extends WsgestionusuarioRequest<org.mivotocuenta.server.ws.wsgestionusuario.model.CollectionResponseUsuario> {
    ...
    protected ListUsuario() {
      super(Wsgestionusuario.this, "GET", REST_PATH, null, org.mivotocuenta.server.ws.wsgestionusuario.model.CollectionResponseUsuario.class);
    }
  ...
  public class RemoveUsuario extends WsgestionusuarioRequest<Void> {
    ...
    protected RemoveUsuario(java.lang.Long id) {
      super(Wsgestionusuario.this, "DELETE", REST_PATH, null, Void.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public UpdateUsuario updateUsuario(org.mivotocuenta.server.ws.wsgestionusuario.model.Usuario content) throws java.io.IOException {
    UpdateUsuario result = new UpdateUsuario(content);
    initialize(result);
    return result;
  }

  public class UpdateUsuario extends WsgestionusuarioRequest<org.mivotocuenta.server.ws.wsgestionusuario.model.Usuario> {
     ...
     * @since 1.13
     */
    protected UpdateUsuario(org.mivotocuenta.server.ws.wsgestionusuario.model.Usuario content) {
      super(Wsgestionusuario.this, "PUT", REST_PATH, content, org.mivotocuenta.server.ws.wsgestionusuario.model.Usuario.class);
    }
  ...
  /**
   * Builder for {@link Wsgestionusuario}.
   *
   * <p>
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    /** Builds a new instance of {@link Wsgestionusuario}. */
    @Override
    public Wsgestionusuario build() {
      return new Wsgestionusuario(this);
    }
    ...
    /**
     * Set the {@link WsgestionusuarioRequestInitializer}.
     *
     * @since 1.12
     */
    public Builder setWsgestionusuarioRequestInitializer(
        WsgestionusuarioRequestInitializer wsgestionusuarioRequestInitializer) {
      return (Builder) super.setGoogleClientRequestInitializer(wsgestionusuarioRequestInitializer);
    }
